...
import { Edit2, Copy, CopyPlus, Trash2, ArrowUpToLine, ArrowDownToLine, Lock, Unlock } from 'lucide-react';
...
export function ContextMenu({
  x, y, isLocked,
  onEdit, onCopy, onDuplicate, onDelete,
  onBringFront, onSendBack, onToggleLock, onClose,
}: ContextMenuProps) {
  ...
  const actions: ContextMenuAction[] = [
    ...
    { label: 'Çoğalt',           icon: <CopyPlus className="h-3.5 w-3.5" />,        onClick: () => { onDuplicate();  onClose(); } },
